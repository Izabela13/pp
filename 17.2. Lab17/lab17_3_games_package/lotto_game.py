...
# Przykładowa ścieżka dostępu do pakietu "games"
sys.path.append("C:\\Kursy\\Python\\packages\\games\\lotto_betting_max_12_numb.py")

from games.lotto_betting_max_12_numb import get_user_numbers, draw_numbers, check_numbers
